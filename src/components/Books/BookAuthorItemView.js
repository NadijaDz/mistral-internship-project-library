  ...
  return (
    <>
      <Modal show={true} onHide={onCloseAuthorView}>
        ...
        <Modal.Body>
          <Container>
            <div className="div-img-view">
              <img
                className="imgAuthorForView"
                src={authorForView.author.image}
              />
            </div>
            <div className="div-description-author">
              ...
              <p>
                {Moment(authorForView.author.birthday).format("DD/MM/YYYY")}
              </p>
              <p className="emailOfAuthor">
                {" "}
                <i className="fa fa-envelope email-icon"> </i>
                {authorForView.author.email}{" "}
              </p>
            </div>
          </Container>
        </Modal.Body>
