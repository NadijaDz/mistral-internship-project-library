...
function BookAuthorsTable({authorsInTable,handleAuthorsOnSubmit,authorsByBook}) {
...
const getAuthors=()=>{
  ...
  return (
    ...
    <ToastContainer />
     ...
     {show && <BookAuthorsModal handleClose={handleClose} allAuthors={allAuthors} authorsForEdit={authorsOnBook} onAuthorSelect={handleAutorSelect}/>} 
